...
# Change ./bin location to after the original PATH to avoid conflicts with repos
# that have a /bin/bash script
export PATH="./node_modules/.bin:${PATH}:./bin:/usr/local/sbin"
